	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	        ...
	        <li class="nav-item">
	          <a class="nav-link" href="index.php?pg=menu">Menu</a>
	        </li>
			...
			<?php if(Auth::access('admin') || Auth::access('supervisor')): ?>
				<li class="nav-item">
					<a class="nav-link <?=($controller == 'inventory' ? 'active' : '')?>" href="index.php?pg=inventory">
						<i class="fa fa-warehouse me-1"></i>Inventory
					</a>
				</li>
			<?php endif; ?>
