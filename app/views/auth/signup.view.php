...
<div class="container-fluid border col-lg-5 col-md-6 mt-5 p-4">
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input value="<?=set_value('username')?>" name="username" type="text" class="form-control <?=!empty($errors['username']) ? 'border-danger':''?>" placeholder="Username">
        ...
        <div class="mb-3">
            ...
            <input value="<?=set_value('email')?>" name="email" type="email" class="form-control <?=!empty($errors['email']) ? 'border-danger':''?>" placeholder="name@example.com">
        ...
        <div class="mb-3">
            ...
            <select name="role" class="form-control <?=!empty($errors['role']) ? 'border-danger':''?>">
                ...
                <option value="supervisor" <?=set_value('role')=='supervisor'?'selected':''?>>Supervisor</option>
                <option value="cashier" <?=set_value('role')=='cashier'?'selected':''?>>Cashier</option>
        ...
        <div class="input-group mb-3">
            ...
            <input value="<?=set_value('password')?>" name="password" type="password" class="form-control <?=!empty($errors['password']) ? 'border-danger':''?>" placeholder="Password">
        ...
        <div class="input-group mb-3">
            ...
            <input value="<?=set_value('password_retype')?>" name="password_retype" type="password" class="form-control <?=!empty($errors['password_retype']) ? 'border-danger':''?>" placeholder="Retype Password">
